...
export default function DashboardPage() {
  ...
  const activityFeed = [
    { user: "John macharia", action: "marked ticket #TK-001 as resolved", time: "2 min ago", color: "green" },
            ...
            <div className="bg-white rounded-lg shadow-2xl overflow-hidden border">
              ...
              <div className="bg-gray-900 px-6 py-4 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-white font-semibold">Tech Solution ltd Dashboard</span>
                </div>
