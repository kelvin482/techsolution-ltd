            ...
            <div className="mb-8">
              ...
              <div className="pl-11">
                ...
                <p className="text-gray-700 mt-4">
                  ...
                  <a href="mailto:privacy@techsolutionltd.com" className="text-blue-600 hover:underline">
                    privacy@techsolutionltd.com
                  </a>
                  .
                </p>
              </div>
              ...
              <div className="pl-11">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="flex items-center mb-2">
                    ...
                    <a href="mailto:privacy@techsolutionltd.com" className="text-blue-600 hover:underline ml-2">
                      privacy@techsolutionltd.com
                    </a>
                  </div>
