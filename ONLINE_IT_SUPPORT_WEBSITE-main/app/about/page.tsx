        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
            <p className="text-xl mb-8">
              At <strong className="text-blue-600">Tech Solution Ltd</strong>, we specialize in providing fast, reliable,
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">What makes Tech Solution Ltd the right choice for your IT needs</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join the growing number of users who trust Tech Solution Ltd for <strong>remote tech support services</strong>{" "}
            that work.
          </p>
